...
const exerciceQuestionsPartA = [
    ...
    {
        id: "exercice_q2a",
        text: "2.a. Quelle est la dérivée $T'(t)$ de la fonction $T(t) = 20 + 30e^{-0.1t}$ ?",
        options: [
...
const exerciceQuestionsPartB = [
    {
        id: "exercice_q4a",
        text: "1. À partir de quel temps $t$ (en heures, valeur approchée à $10^{-2}$ près) la température du composant devient-elle inférieure ou égale à $22^{\\circ}\\text{C}$ ?",
        options: [
    ...
    {
        id: "exercice_q5a",
        text: "2.a. Parmi les fonctions suivantes, laquelle pourrait être une modélisation alternative $S(t)$ respectant $S(0) = T(0)$ et $S(t) \\to 20$ lorsque $t \\to +\\infty$ ?",
        options: [
    ...
    {
        id: "exercice_q5b",
        text: "2.b. Quel est un avantage principal de la modélisation exponentielle $T(t)$ par rapport à une modélisation du type $S(t) = 20 + \\frac{30}{1 + kt}$ pour un phénomène de refroidissement ?",
        options: [
